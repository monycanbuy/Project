...
//       phoneNumber,
//       fullName,
//       roles: [defaultRole._id], // Array of ObjectIds
//     });
...
//       Date.now() - existingUser.verificationCodeValidation < codeExpirationLimit
//     ) {
//       return res.status(400).json({
//         success: false,
//         message:
...
//     // Generate the verification code (number)
//     const codeValue = Math.floor(100000 + Math.random() * 900000); // 6-digit code as a number

//     console.log("Sending email with code:", codeValue);
...
//     if (
//       info.accepted.includes(existingUser.email) &&
...
//       try {
//         existingUser.verificationCode = hashedCodeValue; // Now a string
...
//       }
//     } else {
//       console.error("Email not accepted or rejected:", info);
//       return res.status(400).json({
//         success: false,

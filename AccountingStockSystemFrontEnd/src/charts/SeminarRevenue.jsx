...
} from "../redux/slices/seminarSlice"; // Adjust path
import { WeeklyRevenueOptions } from "./days.config";

const SeminarRevenue = () => {
  ...
  // Process last 7 days for the chart and percentage calculation
  ...
  const calculatePercentageChange = () => {
    const previousWeekRevenue = weeklyData.lastWeekTotal * 1000; // Convert back to full amount
    const currentWeekRevenue = weeklyData.runningWeekTotal * 1000; // Convert back to full amount

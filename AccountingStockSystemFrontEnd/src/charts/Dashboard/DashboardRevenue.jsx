...
const DashboardRevenue = () => {
  ...
  useEffect(() => {
    console.log("Fetching DashboardRevenue data...");
    dispatch(getAllTimeTotalSales());
    dispatch(getMonthlySalesComparison());
    const interval = setInterval(() => {
      dispatch(getAllTimeTotalSales());
    ...
    >
      ...
      <Stack my="20px" direction="row" gap={4} flexWrap="wrap">
        ...
        <Stack direction="row" alignItems="center" gap={1}>
          ...
          <Stack>
            <Typography
              fontSize={15}
              color={isIncrease ? "#fe6c00" : "#ffc397"}
            >
              {percentageChange}%
            </Typography>
            <Typography fontSize={12} color="#808191">
      ...
      <ReactApexChart
        ...
        options={{
          ...
          xaxis: {
            categories: [...monthlyComparison.dates],
            labels: { style: { colors: "#fcfcfc" } },
          },
          yaxis: {
            title: { text: "Sales (₦)", style: { color: "#fcfcfc" } },
            labels: {
              style: { colors: "#fcfcfc" },
              formatter: (value) => `₦${value.toLocaleString("en-NG")}`,
            },
          ...
          fill: { opacity: 1 },
          tooltip: {
            y: { formatter: (value) => `₦${value.toLocaleString("en-NG")}` },
          },
          colors: ["#fe6c00", "#ffc397"],
          legend: { position: "top", labels: { colors: "#fcfcfc" } },
        }}
      />
    </Box>
  );

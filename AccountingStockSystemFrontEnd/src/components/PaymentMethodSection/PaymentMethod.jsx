...
//   useEffect(() => {
//     console.log("useEffect for paymentMethodsStatus:", paymentMethodsStatus);
...
//       const formattedData = list.map((method) => [
//         method.name || "N/A",
//         method._id || "N/A", // Use _id as per your API response
//       ]);
...
//     (index) => {
//       const method = list[index]; // Changed to use 'list'
//       if (!method) {
...
//       setDrawerOpen(true);
//     },
//     [list, setEditPaymentMethodData, setDrawerOpen]
//   );
...
//     },
//     [setPaymentMethodToDelete, setDeleteDialogOpen]
//   );
...
//         .then(() => {
//           dispatch(fetchPaymentMethods()); // Refresh the list after delete
...
//   }, [dispatch, paymentMethodToDelete, setDeleteDialogOpen]);

//   const handleCloseDialog = useCallback(() => {
//     setDeleteDialogOpen(false);
//     setPaymentMethodToDelete(null);
//   }, [setDeleteDialogOpen, setPaymentMethodToDelete]);
...
//           const method = list[tableMeta.rowIndex]; // Changed to use 'list'
//           return (
//             <>
//               <i
...
//                 onClick={() => handleDeleteClick(method._id)} // Changed to use '_id'
//               ></i>
//             </>
//           );
//         },
...
//         size="small"
//         onClick={() => {
//           setEditPaymentMethodData(null); // Reset for new payment method
//           setDrawerOpen(true); // Open drawer for adding new payment method
//         }}
//         sx={{
...
//               onClose={() => {
//                 setDrawerOpen(false);
//                 setEditPaymentMethodData(null); // Reset edit data on close
//               }}

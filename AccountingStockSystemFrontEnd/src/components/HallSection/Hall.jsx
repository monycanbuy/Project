...
// import { fetchHallTransactions } from "../../redux/slices/hallSlice";
...
//   useEffect(() => {
//     console.log("Hall Transactions from state:", hallTransactions);
//     if (
//       hallTransactions &&
...
//           (pm) => pm._id === transaction.paymentMethod
//         );
//         return [
...
//           transaction.staffInvolved
//             ? transaction.staffInvolved.join(", ")
//             : "N/A",

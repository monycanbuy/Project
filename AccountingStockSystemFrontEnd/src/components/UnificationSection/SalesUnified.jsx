    ...
    components: {
      ...
      MuiTab: {
        styleOverrides: {
          root: {
            color: "#fff", // Default color when not selected
            "&.Mui-selected": { color: "#fe6c00" }, // Color when selected
            "&:hover": { color: "#fe6c00" }, // Color on hover
          },
        },
      },
      MuiTabs: {
        styleOverrides: {
          indicator: { backgroundColor: "#fe6c00" }, // Color of the indicator when selected
        },
      },
    },
  });

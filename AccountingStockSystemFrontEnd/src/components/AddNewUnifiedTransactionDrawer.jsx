...
// import PrintSlip from "../components/PrintSection/PrintSlip"; // Import the PrintSlip component
...
//   const handlePrint = () => {
//     console.log("Print Ref:", printRef.current); // Check if ref is set
//     console.log("Slip Data:", slipData); // Check if data is available
...
//   //       console.error("Invalid transaction ID:", initialData._id);
//   //       setFormData({
...
//   //           itemType:
//   //             itemType ||
//   //             (initialData.saleType === "restaurant" ? "Dish" : "Inventory"),
//   //         }))
//   //       );
...
//       // Prepare slipData for the PrintSlip component
//       setSlipData({
//         formData: {
//           saleType: initialData.saleType || "",
...
//       setItems([]);
//       setInventoryChanges([]);
//       setSlipData(null); // Reset slipData when not in edit mode
//     }
//   }, [editMode, initialData, availableDishes, availableInventory]);
...
//         items.filter(
//           (item) =>
//             item.itemType === (value === "restaurant" ? "Dish" : "Inventory")
//         )
//       );
//       setInventoryChanges([]);
...
//         priceAtSale: 0,
//         subTotal: 0,
//         itemType: formData.saleType === "restaurant" ? "Dish" : "Inventory",
//       };
...
//           : availableInventory.find((i) => i._id === event.target.value);
//       if (selectedItem) {
//         newItems[index].priceAtSale =
//           selectedItem.price || selectedItem.unitPrice;
//         newItems[index].subTotal =
//           newItems[index].priceAtSale * newItems[index].quantity;
//         newItems[index].itemType =
//           formData.saleType === "restaurant" ? "Dish" : "Inventory";
//       }
...
//   const addInventoryChange = () => {
//     if (!editMode) {
//       const newChange = {
//         inventoryId: "",
//         quantityChange: 0,
//       };
//       setInventoryChanges([...inventoryChanges, newChange]);
//     }
//   };

//   const removeInventoryChange = (index) => {
//     if (!editMode) {
...
//   const handleInventoryChange = (index, field) => (event) => {
//     const newChanges = [...inventoryChanges];
//     newChanges[index][field] = event.target.value;
//     setInventoryChanges(newChanges);
//   };
...
//     //     itemType: item.itemType,
//     //   })),
//     //   inventoryChanges: inventoryChanges.map((change) => ({
//     //     inventoryId: change.inventoryId,
//     //     quantityChange: Number(change.quantityChange),
//     //   })),
...
//           quantityChange: -Number(item.quantity), // Negative to decrease stock
//         })),
//       discount: Number(formData.discount),
//       location: formData.location,
//     };

//     console.log("Transaction Data Before Dispatch:", transactionData);
...
//     console.log("Transaction ID for update:", initialData._id);
//     console.log("Transaction Data for update:", transactionData);
...
//           toast.error(
//             `Error adding transaction: ${error.response.data.message}`,
//             {
//               duration: 5000,
//             }
//           );
...
//               required
//             >
//               {/* Placeholder for locations, ensure to populate with real data from your system */}
//               {locations.map((loc) => (
...
//                                       key={item._id}
//                                       value={item._id}
//                                       disabled={item.stockQuantity <= 0} // Disable if out of stock
//                                       sx={
...
//                   <TableContainer component={Paper}>
//                     <Table size="small" aria-label="inventory changes table">
//                       <TableHead>
//                         <TableRow>
...
//                             <TableCell align="right">
//                               <IconButton
//                                 onClick={() => removeInventoryChange(index)}
//                               >
//                                 <DeleteIcon />
//                               </IconButton>
//                             </TableCell>
...
//               sx={{
//                 position: "absolute",
//                 bottom: 50, // Adjust this value to move the preview up from the bottom
//                 right: 50, // Adjust this value to move the preview from the right side
//                 zIndex: 1000,
//                 maxHeight: "300px",
//                 maxWidth: "200px", // Add this to control width
//                 overflowY: "auto",
//                 border: "1px solid black",
//                 backgroundColor: "white",
//                 boxShadow: "0 4px 8px rgba(0,0,0,0.1)", // Add some shadow for visibility
//               }}
//             >
...
//     validateField(field, value);
//     if (field === "saleType") {
//       const newItemType = value === "restaurant" ? "Dish" : "Inventory";
//       setItems(
//         items.map((item) => ({
//           ...item,
//           itemType: newItemType,
//           item: "", // Reset item selection when saleType changes
//           priceAtSale: 0,
//           subTotal: 0,
//         }))
//       );
...
//       if (selectedItem) {
//         newItems[index].priceAtSale =
//           selectedItem.price || selectedItem.unitPrice || 0;
//         newItems[index].subTotal =
//           newItems[index].priceAtSale * newItems[index].quantity;
//         newItems[index].itemType =
//           formData.saleType === "restaurant" ? "Dish" : "Inventory";
...
//         ? updateSalesTransaction({
//             transactionId: initialData._id,
//             saleData: transactionData, // Changed transactionData to saleData to match thunk
//           })
//         : createSalesTransaction(transactionData);
...
//         // Update slipData for printing after successful save
//         setSlipData({
//           formData: {
//             saleType: formData.saleType,
//             paymentMethod:
...
//               <MenuItem value="restaurant">Restaurant</MenuItem>
//               <MenuItem value="minimart">Minimart</MenuItem>
//               <MenuItem value="kabasa">Kabasa</MenuItem> {/* Added kabasa */}
//             </Select>
//             {errors.saleType && (
//               <Box sx={{ color: "red", mt: 1 }}>{errors.saleType}</Box>
//             )}

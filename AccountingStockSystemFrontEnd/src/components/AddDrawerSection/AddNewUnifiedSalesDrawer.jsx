...
//     }
//   }, [dispatch, paymentMethodsStatus, dishesStatus]);
...
//           if (!item.item) {
//             error[`items[${index}].item`] = "Item is required";
//           }
//         });
//         break;
//       default:
...
//     if (field === "item") {
//       const selectedItem = availableDishes.find(
...
//   if (paymentMethodsStatus === "loading" || dishesStatus === "loading") {
//     return (
//       <Box
//         sx={{
//           display: "flex",
...
//   if (paymentMethodsStatus === "failed" || dishesStatus === "failed") {
//     return (
//       <Box
//         sx={{
//           display: "flex",
...
//               }}
//               disabled={
//                 paymentMethodsStatus === "loading" || dishesStatus === "loading"
//               }
//             >
